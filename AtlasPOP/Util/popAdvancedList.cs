...
namespace AtlasPOP
{
    public class popAdvancedList<T> : BindingList<T>
    {
        ...
        Action<popAdvancedList<T>, List<T>> populateBaseList = (a, b) => a.ResetItems(b);
        ...
        public popAdvancedList()
        {
            originalList = new List<T>();
        }

        public popAdvancedList(IEnumerable<T> enumerable)
        {
            originalList = enumerable.ToList();
            populateBaseList(this, originalList);
        }

        public popAdvancedList(List<T> list)
        {
            originalList = list;
            populateBaseList(this, originalList);
        }
